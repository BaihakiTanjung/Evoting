...
require_once'functions.php';
    ...
    if($mod=='pemilih_tambah'){
        ...
        elseif($db->get_results("SELECT * FROM tb_pemilih WHERE ktp='$ktp'"))
            ...
            $db->query("INSERT INTO tb_kecamatan (id_kecamatan) VALUES ('$id_kecamatan')");
            $db->query("INSERT INTO tb_desa (id_desa) VALUES ('$id_desa')");

            $result = mysqli_multi_query($config, $query);
            redirect_js("tampilan_depan.php?m=pemilih");
        }    
        ...
        elseif($db->get_results("SELECT * FROM tb_pemilih WHERE ktp='$ktp' AND id_pemilih<>'$_GET[ID]'"))
            ...
            $db->query("UPDATE tb_pemilih SET ktp='$ktp', nama_pemilih='$nama_pemilih', alamat='$alamat' WHERE id_pemilih='$_GET[ID]'");
            redirect_js("tampilan_depan.php?m=pemilih");
        }    
        ...
        header("location:tampilan_depan.php?m=pemilih");
    } 
    ...
    /** PILIH */ 
        ...
        header("location:tampilan_depan.php?m=tanda_terima&act=pilih");
    }    
